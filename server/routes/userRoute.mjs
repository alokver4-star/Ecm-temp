...
// Admin-protected routes (put specific routes BEFORE parameterized routes)
...
router.post(`${routeValue}create`, adminAuth, userRegister); // Admin can create users with any role
...
// Address management routes (admin only) - these have :userId parameter
