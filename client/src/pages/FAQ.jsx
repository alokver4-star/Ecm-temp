      ...
      questions: [
        {
          ...
          answer:
            "You can reach our customer service team via email at support@elaricai.com, phone at 1-800-ELARIC-AI, or through our live chat feature. We're available Monday-Friday 9AM-6PM EST.",
        },
        {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find answers to common questions about shopping with Elaric AI. Cannot
          ...
          <div className="mt-12 bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a
                href="mailto:support@elaricai.com"
