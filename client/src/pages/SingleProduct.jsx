        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <div className="space-y-4">
              <AddToCartButton 
                item={productInfo} 
                className="w-full !py-4 !px-8 !rounded-md !bg-black !text-white hover:!bg-gray-800 !transition-all !duration-300 !font-medium !uppercase !tracking-wider transform hover:scale-[1.02] active:scale-[0.98]"
              />
            </div>
